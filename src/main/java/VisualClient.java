...
public class VisualClient {
    ...
    public void rect(Rectangle rectangle, Color color) {
        Formatter f = new Formatter();
        sendCommand(f.format("rect %1.1f %1.1f %1.1f %1.1f %1.1f %1.1f %1.1f", rectangle.l, rectangle.t,
                rectangle.r, rectangle.b, (float) color.getRed()/255, (float) color.getGreen()/255, (float) color.getBlue()/255).toString());
    }
    ...
    public void fillRect(Rectangle rectangle, Color color) {
        Formatter f = new Formatter();
        sendCommand(f.format("fill_rect %1.1f %1.1f %1.1f %1.1f %1.1f %1.1f %1.1f", rectangle.l, rectangle.t,
                rectangle.r, rectangle.b,
                (float) color.getRed()/255, (float) color.getGreen()/255, (float) color.getBlue()/255).toString());
    }
